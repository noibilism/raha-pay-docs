...
const statusByGroup: Record<string,string[]> = { Payments:["initiated","awaiting_customer","processing","successful","failed"], Payouts:["initiated","processing","successful","failed","reversed"], "Payment links":["active","expired"], "Dedicated accounts":["active","expired"] };
