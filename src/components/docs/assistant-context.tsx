...
type AssistantContextValue={open:boolean;setOpen:(value:boolean)=>void;pageContext:string;snippet?:string;openAssistant:(pageContext?:string,snippet?:string)=>void};
