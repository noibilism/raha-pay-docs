...
export const guides: Guide[] = [
 ...
 g("test-credentials","Getting started","Test credentials","Exercise success, failure and pending paths without moving real money.",[
  s("mobile-tests","Test mobile numbers",["Use these clearly fictional Sandbox numbers with mobile-money requests."],{table:{headers:["Phone number","Network","Outcome"],rows:[["0712 345 678","M-Pesa","successful"],["0712 345 679","M-Pesa","failed"],["0712 345 680","M-Pesa","pending"],["0733 456 781","Airtel Money","successful"],["0733 456 782","Airtel Money","failed"]]}}),
 ...
 g("changelog","Reference","Changelog","Track changes to Raha Pay’s KES API and documentation.",[
  s("2026-09-22","22 Sep 2026, 14:05 EAT",["Published the unified KES documentation, including collections, payouts, virtual accounts, balances, conversions, webhooks and Sandbox testing guidance."]),
